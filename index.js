...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'FN:FARELXDツ\n' //ganti nama lu! 
            + 'ORG: Owner X BOT;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=6288221435170:+62 88221435170\n'  //ganti nomor lu! 
            + 'END:VCARD'
prefix = '#'
blocked = []   
limitawal = 10000
...
/******** OWNER NUMBER**********/
const ownerNumber = ["6288221435170@s.whatsapp.net"]   //ganti nomor lu! 
const pacarNumber = ["6212345678910@s.whatsapp.net"]  //ganti nomor lu!  
/************************************/
